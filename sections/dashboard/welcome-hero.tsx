    ...
    <div className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
      <DashboardCard className="overflow-hidden p-0">
        <div className="relative p-6 sm:p-8">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(76,242,210,0.2),transparent_28%),radial-gradient(circle_at_85%_15%,rgba(255,122,89,0.16),transparent_22%)]" />
          <div className="relative">
            <div className="inline-flex items-center gap-2 rounded-full border border-aurora/25 bg-aurora/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-aurora">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white/58">
      ...
      <DashboardCard className="flex flex-col justify-between">
        <div>
          <p className="text-sm uppercase tracking-[0.28em] text-white/42">Today’s vibe</p>
