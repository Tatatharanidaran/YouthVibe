        ...
        <DashboardCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/44">Visible strengths that shape how opportunities match.</p>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {profile.skills.map((skill) => (
              <div
                key={skill}
                className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-sm font-medium text-white/64"
              >
                {skill}
              </div>
            ))}
        ...
        <DashboardCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/44">Themes shaping events, rewards, and discovery across YouthVibe.</p>
            </div>
          </div>
